...
impl BanScore for orders_accounting::Error {
    fn ban_score(&self) -> u32 {
        ...
        match self {
            ...
            Error::InvariantOrderDataNotExistForFreezeUndo(_) => 100,
            ...
            Error::AttemptedFreezeNonexistingOrderData(_) => 100,
            Error::AttemptedFreezeAlreadyFrozenOrder(_) => 100,
            Error::AttemptedFillFrozenOrder(_) => 100,
